...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioMute", function ()
        ...
        volume_widget:toggle()
              ...
              {description = "mute", group = "controls"}),
    ...
    -- System
    awful.key({ modkey,           }, "z", function () awful.util.spawn(screenlocker, false) end,
              {description = "lock screen", group = "controls"}),
    awful.key({ modkey, "Control" }, "Escape", function () awful.util.spawn("shutdown now", false) end,
              {description = "shutdown", group = "controls"}),
